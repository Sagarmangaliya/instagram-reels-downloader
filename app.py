...
def download_reel():
    ...
    try:
        ...
        # Prepare data and headers for saveig.in API
        post_data = {
            'q': reel_url,
            't': 'media',
            'lang': 'en'
        ...
        # Send POST request to saveig.in
        ...
        if not response_json.get("data"):
            logging.error("No data received from saveig.in")
            return jsonify({"error": "No data received from saveig.in"}), 500
